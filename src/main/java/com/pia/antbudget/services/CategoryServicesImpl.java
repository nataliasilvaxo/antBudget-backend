...
public class CategoryServicesImpl implements ICategoryService{
	...
	public ResponseEntity<CategoryResponseRest> searchById(Long id) {
		...
		try {
			...
			Optional <Category> category = categoryDao.findById(id);//este metodo devuelve un objeto optional
	...
	public ResponseEntity<CategoryResponseRest> save(Category category) {
		...
		try {
			...
			Category categorySaved = categoryDao.save(category);//aqui se guarda el registro en la base de datos
	...
	public ResponseEntity<CategoryResponseRest> update(Category category, Long id) {
		...
		try {
			...
			if(categorySearch.isPresent()) {
				...
				//esto es lo que actualiza en la base de datos
